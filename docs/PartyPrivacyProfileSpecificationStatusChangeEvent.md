...
**event** | [**PartyPrivacyProfileSpecificationStatusChangeEventPayload**](PartyPrivacyProfileSpecificationStatusChangeEventPayload.md) | The event payload linked to the involved resource object | [optional] 
