...
class RoleSpecification(object):
    ...
    def __init__(self, description=None, name=None, base_type=None, schema_location=None, type=None):  # noqa: E501
        """RoleSpecification - a model defined in Swagger"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this RoleSpecification.  # noqa: E501

        An explanatory text documenting the role specification  # noqa: E501

        :return: The description of this RoleSpecification.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this RoleSpecification.

        An explanatory text documenting the role specification  # noqa: E501

        :param description: The description of this RoleSpecification.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this RoleSpecification.  # noqa: E501

        The name of the role specification. This name uniquely identifies the role specification  # noqa: E501

        :return: The name of this RoleSpecification.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this RoleSpecification.

        The name of the role specification. This name uniquely identifies the role specification  # noqa: E501

        :param name: The name of this RoleSpecification.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def base_type(self):
        """Gets the base_type of this RoleSpecification.  # noqa: E501

        When sub-classing, this defines the super-class  # noqa: E501

        :return: The base_type of this RoleSpecification.  # noqa: E501
        :rtype: str
        """
    ...
    def base_type(self, base_type):
        """Sets the base_type of this RoleSpecification.

        When sub-classing, this defines the super-class  # noqa: E501

        :param base_type: The base_type of this RoleSpecification.  # noqa: E501
        :type: str
        """
    ...
    def schema_location(self):
        """Gets the schema_location of this RoleSpecification.  # noqa: E501

        A URI to a JSON-Schema file that defines additional attributes and relationships  # noqa: E501

        :return: The schema_location of this RoleSpecification.  # noqa: E501
        :rtype: str
        """
    ...
    def schema_location(self, schema_location):
        """Sets the schema_location of this RoleSpecification.

        A URI to a JSON-Schema file that defines additional attributes and relationships  # noqa: E501

        :param schema_location: The schema_location of this RoleSpecification.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this RoleSpecification.  # noqa: E501

        When sub-classing, this defines the sub-class entity name  # noqa: E501

        :return: The type of this RoleSpecification.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this RoleSpecification.

        When sub-classing, this defines the sub-class entity name  # noqa: E501

        :param type: The type of this RoleSpecification.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RoleSpecification, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RoleSpecification):
            return False
