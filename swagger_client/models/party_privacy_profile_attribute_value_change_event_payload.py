...
class PartyPrivacyProfileAttributeValueChangeEventPayload(object):
    ...
    def __init__(self, party_privacy_profile=None):  # noqa: E501
        """PartyPrivacyProfileAttributeValueChangeEventPayload - a model defined in Swagger"""  # noqa: E501
    ...
    def party_privacy_profile(self):
        """Gets the party_privacy_profile of this PartyPrivacyProfileAttributeValueChangeEventPayload.  # noqa: E501

        The involved resource data for the event  # noqa: E501

        :return: The party_privacy_profile of this PartyPrivacyProfileAttributeValueChangeEventPayload.  # noqa: E501
        :rtype: PartyPrivacyProfile
        """
        return self._party_privacy_profile

    @party_privacy_profile.setter
    def party_privacy_profile(self, party_privacy_profile):
        """Sets the party_privacy_profile of this PartyPrivacyProfileAttributeValueChangeEventPayload.

        The involved resource data for the event  # noqa: E501

        :param party_privacy_profile: The party_privacy_profile of this PartyPrivacyProfileAttributeValueChangeEventPayload.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PartyPrivacyProfileAttributeValueChangeEventPayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PartyPrivacyProfileAttributeValueChangeEventPayload):
            return False
