...
class PartyPrivacyProfileSpecificationStatusChangeEventPayload(object):
    ...
    def __init__(self, party_privacy_profile_specification=None):  # noqa: E501
        """PartyPrivacyProfileSpecificationStatusChangeEventPayload - a model defined in Swagger"""  # noqa: E501
    ...
    def party_privacy_profile_specification(self):
        """Gets the party_privacy_profile_specification of this PartyPrivacyProfileSpecificationStatusChangeEventPayload.  # noqa: E501

        The involved resource data for the event  # noqa: E501

        :return: The party_privacy_profile_specification of this PartyPrivacyProfileSpecificationStatusChangeEventPayload.  # noqa: E501
    ...
    def party_privacy_profile_specification(self, party_privacy_profile_specification):
        """Sets the party_privacy_profile_specification of this PartyPrivacyProfileSpecificationStatusChangeEventPayload.

        The involved resource data for the event  # noqa: E501

        :param party_privacy_profile_specification: The party_privacy_profile_specification of this PartyPrivacyProfileSpecificationStatusChangeEventPayload.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PartyPrivacyProfileSpecificationStatusChangeEventPayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PartyPrivacyProfileSpecificationStatusChangeEventPayload):
            return False
