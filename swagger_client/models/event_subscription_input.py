...
class EventSubscriptionInput(object):
    ...
    def __init__(self, callback=None, query=None):  # noqa: E501
        """EventSubscriptionInput - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def callback(self):
        """Gets the callback of this EventSubscriptionInput.  # noqa: E501

        The callback being registered.  # noqa: E501

        :return: The callback of this EventSubscriptionInput.  # noqa: E501
        :rtype: str
        """
    ...
    def callback(self, callback):
        """Sets the callback of this EventSubscriptionInput.

        The callback being registered.  # noqa: E501

        :param callback: The callback of this EventSubscriptionInput.  # noqa: E501
        :type: str
        """
        if callback is None:
    ...
    @property
    def query(self):
        """Gets the query of this EventSubscriptionInput.  # noqa: E501

        additional data to be passed  # noqa: E501

        :return: The query of this EventSubscriptionInput.  # noqa: E501
        :rtype: str
        """
        return self._query
    ...
    def query(self, query):
        """Sets the query of this EventSubscriptionInput.

        additional data to be passed  # noqa: E501

        :param query: The query of this EventSubscriptionInput.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EventSubscriptionInput, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EventSubscriptionInput):
            return False
