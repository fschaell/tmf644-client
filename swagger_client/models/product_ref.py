...
class ProductRef(object):
    ...
    def __init__(self, id=None, href=None, name=None, base_type=None, schema_location=None, type=None, referred_type=None):  # noqa: E501
        """ProductRef - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this ProductRef.  # noqa: E501

        Unique identifier of a related entity.  # noqa: E501

        :return: The id of this ProductRef.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ProductRef.

        Unique identifier of a related entity.  # noqa: E501

        :param id: The id of this ProductRef.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def href(self):
        """Gets the href of this ProductRef.  # noqa: E501

        Reference of the related entity.  # noqa: E501

        :return: The href of this ProductRef.  # noqa: E501
        :rtype: str
        """
        return self._href
    ...
    @href.setter
    def href(self, href):
        """Sets the href of this ProductRef.

        Reference of the related entity.  # noqa: E501

        :param href: The href of this ProductRef.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this ProductRef.  # noqa: E501

        Name of the related entity.  # noqa: E501

        :return: The name of this ProductRef.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ProductRef.

        Name of the related entity.  # noqa: E501

        :param name: The name of this ProductRef.  # noqa: E501
        :type: str
        """
    ...
    @property
    def base_type(self):
        """Gets the base_type of this ProductRef.  # noqa: E501

        When sub-classing, this defines the super-class  # noqa: E501

        :return: The base_type of this ProductRef.  # noqa: E501
        :rtype: str
        """
    ...
    def base_type(self, base_type):
        """Sets the base_type of this ProductRef.

        When sub-classing, this defines the super-class  # noqa: E501

        :param base_type: The base_type of this ProductRef.  # noqa: E501
        :type: str
        """
    ...
    def schema_location(self):
        """Gets the schema_location of this ProductRef.  # noqa: E501

        A URI to a JSON-Schema file that defines additional attributes and relationships  # noqa: E501

        :return: The schema_location of this ProductRef.  # noqa: E501
        :rtype: str
        """
    ...
    def schema_location(self, schema_location):
        """Sets the schema_location of this ProductRef.

        A URI to a JSON-Schema file that defines additional attributes and relationships  # noqa: E501

        :param schema_location: The schema_location of this ProductRef.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this ProductRef.  # noqa: E501

        When sub-classing, this defines the sub-class entity name  # noqa: E501

        :return: The type of this ProductRef.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ProductRef.

        When sub-classing, this defines the sub-class entity name  # noqa: E501

        :param type: The type of this ProductRef.  # noqa: E501
        :type: str
        """
    ...
    def referred_type(self):
        """Gets the referred_type of this ProductRef.  # noqa: E501

        The actual type of the target instance when needed for disambiguation.  # noqa: E501

        :return: The referred_type of this ProductRef.  # noqa: E501
        :rtype: str
        """
    ...
    def referred_type(self, referred_type):
        """Sets the referred_type of this ProductRef.

        The actual type of the target instance when needed for disambiguation.  # noqa: E501

        :param referred_type: The referred_type of this ProductRef.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProductRef):
            return False
