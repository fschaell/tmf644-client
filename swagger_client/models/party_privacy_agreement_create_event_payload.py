...
class PartyPrivacyAgreementCreateEventPayload(object):
    ...
    def __init__(self, party_privacy_agreement=None):  # noqa: E501
        """PartyPrivacyAgreementCreateEventPayload - a model defined in Swagger"""  # noqa: E501
    ...
    def party_privacy_agreement(self):
        """Gets the party_privacy_agreement of this PartyPrivacyAgreementCreateEventPayload.  # noqa: E501

        The involved resource data for the event  # noqa: E501

        :return: The party_privacy_agreement of this PartyPrivacyAgreementCreateEventPayload.  # noqa: E501
    ...
    def party_privacy_agreement(self, party_privacy_agreement):
        """Sets the party_privacy_agreement of this PartyPrivacyAgreementCreateEventPayload.

        The involved resource data for the event  # noqa: E501

        :param party_privacy_agreement: The party_privacy_agreement of this PartyPrivacyAgreementCreateEventPayload.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PartyPrivacyAgreementCreateEventPayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PartyPrivacyAgreementCreateEventPayload):
            return False
